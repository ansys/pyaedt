...
sweepname = aedtapp.create_linear_count_sweep(name="MySetup", unit="GHz", start_frequency=0.8, stop_frequency=1.2,
...
ipkapp.assign_em_losses(map_frequency="1GHz", surface_objects=surfaceobj, parameters=["$coax_dimension", "inner"])
