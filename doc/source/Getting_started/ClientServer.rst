...
- You can export ``ANSYSEM_ROOT241=/path/to/AnsysEM/v222/Linux64``.
- You can export ``LD_LIBRARY_PATH=$ANSYSEM_ROOT241/common/mono/Linux64/lib:$ANSYSEM_ROOT241/Delcross:$LD_LIBRARY_PATH``.
