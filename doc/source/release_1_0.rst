...
Please be advised that, with the release of version 1.0 of our PyAEDT, Python versions 3.8 and 3.9
will be deprecated. This decision has been made in order to align with the Python Scientific
Community's best practices. It is important to note that many packages within the Scientific Python
Community have dropped support for these Python versions a while ago. Therefore, our move to
deprecate these versions is also a step towards maintaining compatibility and taking full advantage
of these scientific packages.
