...
desktop = Desktop(version="2025.2", new_desktop=True, non_graphical=False, close_on_exit=True)
...
desktop = Desktop(version="2025.2", new_desktop=True, non_graphical=True, close_on_exit=True)
app = Maxwell3d()
```
