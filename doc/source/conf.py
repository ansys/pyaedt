...
local_path = PurePath(Path(__file__).resolve()).parent
module_path = Path(local_path)
root_path = module_path.parent.parent
try:
    from ansys.aedt.core import __version__
except ImportError:

    sys.path.append(Path(PurePath(local_path)).absolute())
    sys.path.append(PurePath(root_path))
    from ansys.aedt.core import __version__
