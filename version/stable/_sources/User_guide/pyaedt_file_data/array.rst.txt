...
For a practical demonstration, see the `Antenna array example <https://examples.aedt.docs.pyansys.com/version/dev/examples/high_frequency/antenna/array.html>`_.
