...
from ansys.aedt.core.generic.settings import DEFAULT_GRPC_LISTEN_ALL, DEFAULT_GRPC_LOCAL, DEFAULT_GRPC_SECURE_MODE
...
def get_local_ip():
    ...
    try:
        # On se connecte à une adresse "extérieure" (pas besoin qu'elle réponde)
...
def create_server_certificate(server_key: rsa.RSAPrivateKey, ca_cert: x509.Certificate, ca_key: rsa.RSAPrivateKey, server_common_name: str, validity_days: int, san_names: list = None) -> x509.Certificate:
    """
...
def create_client_certificate(client_key: rsa.RSAPrivateKey, ca_cert: x509.Certificate, ca_key: rsa.RSAPrivateKey, client_common_name: str, validity_days: int) -> x509.Certificate:
    """
...
def generate_server_certificates(ca_cert: x509.Certificate, ca_key: rsa.RSAPrivateKey, server_specs: list, validity_days: int) -> list:
    """
