...
class TestClass(BasisTest, object):
    ...
    def test_47_heal_objects(self):
        self.aedtapp.set_active_design("Motion")
        assert self.aedtapp.modeler.heal_objects(input_objects_list="impedance_box")
        assert self.aedtapp.modeler.heal_objects(input_objects_list="impedance_box,impedance_box_copper,Inner_Box")
        assert self.aedtapp.modeler.heal_objects(input_objects_list="impedance_box, impedance_box_copper, Inner_Box ")
        assert not self.aedtapp.modeler.heal_objects(
            input_objects_list=["impedance_box", "impedance_box_copper", "Inner_Box"]
        )
        assert not self.aedtapp.modeler.heal_objects(input_objects_list="impedance_box", simplify_type=3)
        assert self.aedtapp.modeler.heal_objects(input_objects_list="impedance_box_copper", max_stitch_tolerance="0.01")
        assert self.aedtapp.modeler.heal_objects(input_objects_list="Inner_Box", max_stitch_tolerance=0.01)
        ...
        assert self.aedtapp.modeler.heal_objects(input_objects_list="impedance_box,Inner_Box", tighten_gaps_width=0.001)
        assert self.aedtapp.modeler.heal_objects(
            input_objects_list="impedance_box,Inner_Box", tighten_gaps_width="0.001"
        )
        assert self.aedtapp.modeler.heal_objects(
            input_objects_list="impedance_box,Inner_Box", silver_face_tolerance=1.2
        )
        assert self.aedtapp.modeler.heal_objects(
            input_objects_list="impedance_box,Inner_Box", silver_face_tolerance="1.2"
        )
