...
def test_pole_zeros_response_getter():
    ...
    proto_rx_zero_den_x = design.ideal_response._pole_zeros_response_getter(PoleZerosResponseColumn.PROTO_RX_ZERO_DEN_X)
    ...
    proto_rx_zero_den_y = design.ideal_response._pole_zeros_response_getter(PoleZerosResponseColumn.PROTO_RX_ZERO_DEN_Y)
    ...
    proto_rx_zero_num_x = design.ideal_response._pole_zeros_response_getter(PoleZerosResponseColumn.PROTO_RX_ZERO_NUM_X)
    ...
    proto_rx_zero_num_y = design.ideal_response._pole_zeros_response_getter(PoleZerosResponseColumn.PROTO_RX_ZERO_NUM_Y)
...
def test_transfer_function_response():
    ...
    lines_list_file = list_file.readlines()
    for i in range(len(lines_list_file)):
        assert lines_list_file[i] == lines_list[i] + "\n"
