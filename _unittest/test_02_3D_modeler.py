...
class TestClass:
    ...
    def test_47_sweep_along_vector(self):
        ...
        rect2 = self.aedtapp.modeler.create_rectangle(self.aedtapp.PLANE.YZ, [0, 40, 0], [20, 20],
                                                      "rectangle_to_vector2")
        rect3 = self.aedtapp.modeler.create_rectangle(self.aedtapp.PLANE.YZ, [0, 80, 0], [20, 20],
                                                      "rectangle_to_vector3")
