...
class TestMaterial:
    ...
    def test_create_material(self):
        ...
        mat1.thermal_expansion_coefficient.value = MatProperties.get_defaultvalue(aedtname="thermal_expansion_coefficient")
    ...
    def test_surface_material(self):
        ...
        assert mat2.surface_diffuse_absorptance.value == SurfMatProperties.get_defaultvalue(aedtname="surface_diffuse_absorptance")
