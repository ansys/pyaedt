...
class TestClass(BasisTest, object):
    ...
    def test_02_create_material(self):
        ...
        mat1.loss_tangent.value = MatProperties.get_defaultvalue(aedtname="dielectric_loss_tangent")
        assert mat1.loss_tangent.value == MatProperties.get_defaultvalue(aedtname="dielectric_loss_tangent")
