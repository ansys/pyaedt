...
class TestMessage:
    ...
    def test_01_messaging(self):
        self.aedtapp.messenger.add_info_message("Test Info")
        self.aedtapp.messenger.add_info_message("Test Info", "Project")
        self.aedtapp.messenger.add_info_message("Test Info", 'Global')
        self.aedtapp.messenger.add_warning_message("Test Warning")
        self.aedtapp.messenger.add_warning_message("Test Warning", "Project")
        self.aedtapp.messenger.add_warning_message("Test Warning", 'Global')
        self.aedtapp.messenger.add_error_message("Test Error")
        self.aedtapp.messenger.add_error_message("Test Error", "Project")
        self.aedtapp.messenger.add_error_message("Test Error", 'Global')
        self.aedtapp.messenger.add_debug_message("Test Debug")
        self.aedtapp.messenger.add_debug_message("Test Debug", "Project")
        self.aedtapp.messenger.add_debug_message("Test Debug", 'Global')
        pass
