...
solutions_types = {
    'Maxwell 2D':
    {
        'Magnetostatic': {'name': 'Magnetostatic', 'options': 'XY', 'report_type': 'Magnetostatic',
                          'default_setup': 6, 'default_adaptive': 'LastAdaptive'},
        'EddyCurrent': {'name': 'EddyCurrent', 'options': 'XY', 'report_type': 'EddyCurrent', 'default_setup': 7,
                        'default_adaptive': 'LastAdaptive'},
        'Transient': {'name': 'Transient', 'options': 'XY', 'report_type': 'Transient', 'default_setup': 5,
                      'default_adaptive': 'Transient'},
        'Electrostatic': {'name': 'Electrostatic', 'options': 'XY', 'report_type': 'Electrostatic',
                          'default_setup': 8, 'default_adaptive': 'LastAdaptive'},
        'ElectricTransient': {'name': 'ElectricTransient', 'options': 'XY', 'report_type': None,
                              'default_setup': 10, 'default_adaptive': 'Transient'},
        'ElectroDCConduction': {'name': 'ElectroDCConduction', 'options': 'XY', 'report_type': None,
                                'default_setup': 9, 'default_adaptive': 'LastAdaptive'}
    },
    'Maxwell 3D':
        {
            'Magnetostatic': {'name': 'Magnetostatic', 'options': None, 'report_type': 'Magnetostatic',
                              'default_setup': 6,
                              'default_adaptive': 'LastAdaptive'},
            'EddyCurrent': {'name': 'EddyCurrent', 'options': None, 'report_type': 'EddyCurrent', 'default_setup': 7,
                            'default_adaptive': 'LastAdaptive'},
            'Transient': {'name': 'Transient', 'options': None, 'report_type': 'Transient', 'default_setup': 5,
                          'default_adaptive': 'Transient'},
            'Electrostatic': {'name': 'Electrostatic', 'options': None, 'report_type': 'Electrostatic',
                              'default_setup': 8,
                              'default_adaptive': 'LastAdaptive'},
            'DCConduction': {'name': None, 'options': None, 'report_type': None, 'default_setup': None,
                             'default_adaptive': None},
            'ElectroDCConduction': {'name': 'ElectroDCConduction', 'options': None, 'report_type': None,
                                    'default_setup': 9,
                                    'default_adaptive': 'LastAdaptive'},
            'ElectricTransient': {'name': 'ElectricTransient', 'options': None, 'report_type': None,
                                  'default_setup': 10,
                                  'default_adaptive': 'Transient'}
        },
    'Twin Builder':
    ...
    '2D Extractor':
        {
            'Open': {'name': 'Open', 'options': None, 'report_type': None, 'default_setup': 30,
                     'default_adaptive': None},
            'Closed': {'name': 'Closed', 'options': None, 'report_type': None, 'default_setup': 31,
                       'default_adaptive': None}
        },
    'Q3D Extractor':
        {
    ...
    'HFSS':
        {
            'Modal': {'name': 'DrivenModal',
                      'options': None,
                      'report_type': 'Modal Solution Data',
                      'default_setup': 1,
                      'default_adaptive': 'LastAdaptive'},
            'Terminal': {'name': 'DrivenTerminal',
                         'options': None,
            ...
            'Characteristic': {'name': "Characteristic Mode",
                               'options': None,
                               'report_type': None,
                               'default_setup': None,
                               'default_adaptive': None},
            'SBR+': {'name': 'SBR+', 'options': None, 'report_type': 'Modal Solution Data', 'default_setup': 4,
                     'default_adaptive': None}
        },
    'Icepak':
        {
            'SteadyState': {
                'name': 'SteadyState', 'options': 'TemperatureAndFlow', 'report_type': 'Monitor', 'default_setup': 11,
                'default_adaptive': None},
            'Transient': {
                'name': 'Transient', 'options': 'TemperatureAndFlow', 'report_type': 'Monitor', 'default_setup': 36,
                'default_adaptive': None},
        },
    'RMxprtSolution':
        {
            'IRIM': {'name': 'IRIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'ORIM': {'name': 'ORIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'SRIM': {'name': 'SRIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'WRIM': {'name': 'WRIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'DFIG': {'name': 'DFIG', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'AFIM': {'name': 'AFIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'HM': {'name': 'HM', 'options': None, 'report_type': None, 'default_setup': 34,
                   'default_adaptive': None},
            'RFSM': {'name': 'RFSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'RASM': {'name': 'RASM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'RSM': {'name': 'RSM', 'options': None, 'report_type': None, 'default_setup': 34,
                    'default_adaptive': None},
            'ISM': {'name': 'ISM', 'options': None, 'report_type': None, 'default_setup': 34,
                    'default_adaptive': None},
            'APSM': {'name': 'APSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'IBDM': {'name': 'IBDM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'ABDM': {'name': 'ABDM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'TPIM': {'name': 'TPIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'SPIM': {'name': 'SPIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'TPSM': {'name': 'TPSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'BLDC': {'name': 'BLDC', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'ASSM': {'name': 'ASSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'PMDC': {'name': 'PMDC', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'SRM': {'name': 'SRM', 'options': None, 'report_type': None, 'default_setup': 34,
                    'default_adaptive': None},
            'LSSM': {'name': 'LSSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'UNIM': {'name': 'UNIM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'DCM': {'name': 'DCM', 'options': None, 'report_type': None, 'default_setup': 34,
                    'default_adaptive': None},
            'CPSM': {'name': 'CPSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None},
            'NSSM': {'name': 'NSSM', 'options': None, 'report_type': None, 'default_setup': 34,
                     'default_adaptive': None}},
    'ModelCreation':
        {
            'IRIM': {'name': 'IRIM', 'options': None, 'report_type': None, 'default_setup': 34,
    ...
    'Mechanical':
        {
            'Thermal': {'name': 'Thermal', 'options': None, 'report_type': None, 'default_setup': 32,
                        'default_adaptive': None},
            'Modal': {'name': 'Modal', 'options': None, 'report_type': None, 'default_setup': 33,
                      'default_adaptive': None},
            'Structural': {'name': 'Structural', 'options': None, 'report_type': None, 'default_setup': 39,
                           'default_adaptive': 'Solution'}
        },
    'EMIT':
        {
            'EMIT': {'name': None, 'options': None, 'report_type': None, 'default_setup': None,
                     'default_adaptive': None}
        }
}
...
class IcepakDesignSolution(DesignSolution, object):
    ...
    def solution_type(self, soltype):
        if soltype in self._solution_options and self._solution_options[soltype]["name"]:
            self._solution_type = soltype
            options = ["NAME:SolutionTypeOption", "SolutionTypeOption:=", soltype, "ProblemOption:=",
                       self._problem_type]
            try:
