...
from ..generic.string_handling import variation_string_to_dict
...
class Design(object):
    ...
    def __init__(self, design_type, project_name=None, design_name=None, solution_type=None,
        ...
        self._aedt_desktop = Desktop(specified_version, non_graphical, launch_new_desktop, release_on_exit, student_version)
