...
class CoordinateSystem(object):
    ...
    def setWorkingCoordinateSystem(self, name=None):
        ...
        :param name: name of CS to become active
    ...
    def _change_property(self, name, arg):
        ...
        :param arg: list with parameters about what to change, e.g. ["NAME:ChangedProps", ["NAME:Mode", "Value:=", "Axis/Position"]]
        :return:
        """
    ...
    def change_cs_mode(self, mode_type=0):
        ...
        :param mode_type:0 for "Axis/Position", 1 for "Euler Angle ZYZ", 2 for "Euler Angle ZXZ"
        :return: bool
        """
        if mode_type == 0:
    ...
    def create(self, origin=[0, 0, 0], view="iso", x_pointing=[1, 0, 0], y_pointing=[0, 1, 0], reference_cs="Global", name=None):
        ...
        :param view: View. Default "iso". possible "XY", "XZ", "XY", "rotate"
        :param x_pointing: if view="rotate", this is a 3 elements list specifing the X axis pointing in the global CS
        :param y_pointing: if view="rotate", this is a 3 elements list specifing the Y axis pointing in the global CS
...
class GeometryModeler(Modeler, object):
    ...
    def add_workbench_link(self, objects, ambient_temp=22, create_project_var=False, enable_deformation=True):
        ...
        :param enable_deformation: Boolean if True the deformation link is added
        :param create_project_var: Boolean if True $AmbientTemp is created.
        :param ambient_temp: ambient temperature default value
        :param objects: list of the object to be included
        """
    ...
    def set_objects_temperature(self, objects, ambient_temp=22, create_project_var=False):
        ...
        :param create_project_var: Boolean if True $AmbientTemp is created.
        :param ambient_temp: ambient temperature default value = 22
        :param objects: list of the object to be included
        """
    ...
    def create_sheet_to_ground(self, objectname, groundname=None, axisdir=0, sheet_dim=1):
        ...
        :param groundname: Ground Name if None it will connect to bounding box
        :param axisdir: Axis Dir
        :param sheet_dim: Sheet dimension. Default 1mm
        :return: rectangle ID
        """
    ...
    def set_object_model_state(self, obj_list, model=True):
        ...
        :param obj_list: list of objects ids or name
        :param model: Bool set status
    ...
    def get_objects_in_group(self, group):
        ...
        :return: array of 6 elements representing bounding box
        """
    ...
    def split(self, objects, plane, sides="Both"):
        ...
        :param objects: it contains an object or a list of objects to be. if it is a string, it is expected an object name, otherwise and object id
        :param plane: plane of cut. Applications.CoordinateSystemPlane.XXXXXX
        :param sides: which side to keep. "Both" means that all the objects are kept after the split. PositiveOnly and NegativeOnly are allowed
        :return: True if the split success
        """
    ...
    def duplicate_and_mirror(self, objid, position, vector):
        ...
        :param objid: if str, it is considered an objecname. if Int it is considered an object id
        :param position: List of Position [x,y,z] or Application.Position object
        :param vector:  List of Vector [x1,y1,z1] or Application.Position object
        :return: List of new objects created or Empty List
        """
    ...
    def mirror(self, objid, position, vector):
        ...
        :param objid: if str, it is considered an objecname. if Int it is considered an object id
        :param position: array of position orApplication.Position object
        :param vector: array of vector for mirroring or Application.Position object
    ...
    def duplicate_around_axis(self, objid, cs_axis, angle=90, nclones=2, create_new_objects=True):
        ...
        :param objid: if str, it is considered an objecname. if Int it is considered an object id
        :param cs_axis: Application.CoordinateSystemAxis object
        :param angle: Flaat angle of rotation
        :param nclones: number of clones
        :param create_new_objects: Flag whether to create create copies as new objects, defaults to True
        :return:
        """
        selections = self.convert_to_selections(objid)
    ...
    def thicken_sheet(self, objid, thickness, bBothSides=False):
        ...
        :param objid: if str, it is considered an objecname. if Int it is considered an object id
        :param thickness: Thickness of thicken. Float
        :param bBothSides:  Boolean. Thicken on both side
        :return:
        """
        selections = self.convert_to_selections(objid)
    ...
    def sweep_along_vector(self, objid, sweepVector, sweepoptions):
        ...
        :param objid: if str, it is considered an objecname. if Int it is considered an object id
        :param sweepVector: Application.Position object
        :param sweepoptions:  Application.SweepOptions object
        :return:
        """
        selections = self.convert_to_selections(objid)
    ...
    def sweep_around_axis(self, objid, cs_axis, sweepAngle, sweepoptions):
        ...
        :param objid: if str, it is considered an objecname. if Int it is considered an object id
        :param cs_axis: Application.CoordinateSystemAxis object
        :param sweepAngle: float. Sweep Angle in degrees
        :param sweepoptions:  Application.SweepOptions object
        :return:
        """
        selections = self.convert_to_selections(objid)
    ...
    def section(self, object_list, plane, create_new=True, section_cross_object=False):
        ...
        :param object_list: list. if is list of string , it is considered an objecname. if Int it is considered an object id
        :param plane: Application.CoordinateSystemPlane object
        :param create_new: Bool.
        :param section_cross_object:  Bool
        :return:
        """
        planes = {0: "XY", 1: "YZ", 2: "ZX"}
    ...
    def separate_bodies(self, object_list, create_group=False):
        ...
        :param object_list: list of objects to separate
        :param create_group:
        :return:
        """
        selections = self.convert_to_selections(object_list)
    ...
    def subtract(self, theList, theList1, keepOriginals=True):
        ...
        :param theList:list of IDs from which subtract
        :param theList1:list of IDs to subtract
        :param keepOriginals: define to keep original or not
        :type keepOriginals: bool
        :return: True if succeeded
    ...
    def purge_history(self, theList):
        ...
        :param theList:list of object to purge
        :return: True if succeeded
        """
        szList = self.convert_to_selections(theList)
    ...
    def chamfer(self, object_name, edge_list=None, vertices_list=None, left_distance=1, right_distance=None, angle=45, chamfer_type=0):
        ...
        :param edge_list: list of edges to which apply chamfer
        :param vertices_list: list of vertices to which apply chamfer. Alternative to edge_list
        :param left_distance: float left distance
        :param right_distance: float optional right distance
        :param angle: float angle (for type 2 and 3)
        :param chamfer_type: 0 - Simmetric , 1 - Left Distance-Right Distance, 2 - Left Distance-Angle, 3 - Right Distance-Angle
        :return: bool
        """
    ...
    def fillet(self, object_name, edge_list=None, vertices_list=None, radius=0.1, setback=0):
        ...
        :param object_name: name of the object
        :param edge_list: list of edges to which apply fillet
        :param vertices_list: list of vertices to which apply fillet. Alternative to edge_list
        :param radius: float Fillet Radius
        :param setback: float Fillet setback
        :return: Bool
        """
        if self.primitives.objects[self.primitives.objects_names[object_name]].is3d:
            if edge_list:
    ...
    def clone(self, objid):
        ...
        :param objid:list of object
        :return: True if succeeded, object name cloned
        """
    ...
    def intersect(self, theList, keeporiginal=False):
        ...
        :param theList:list of object
        :param keeporiginal: boolan Keep Original
        :return: True if succeeded
        """
    ...
    def translate(self, objid, vector):
        ...
        :param objid:list of object
        :param vector: vector of direction move. It can be an array or a Position object
        :return: True if succeeded
        """
    ...
    def chassis_subtraction(self, chassis_part):
        ...
        :param chassis_part:object name belonging to chassis
        :return:
        """
    ...
    def check_plane(self, obj, faceposition, offset=1):
        ...
        :param faceposition: face position
    ...
    def create_airbox(self, offset=0, offset_type="Absolute", defname="AirBox_Auto"):
        ...
        :param offset: dBl offset value to be applied on airbox faces vs bounding box
        :param offset_type: Offset type, Default "Absolute". Optional "Relative" with offset input between 0 and 100
        :param defname: Name of the Airbox
    ...
    def create_air_region(self, x_pos=0, y_pos=0, z_pos=0, x_neg=0, y_neg=0, z_neg=0):
        ...
        :param x_pos: padding in percent in +X direction (+R for 2D RZ)
        :param y_pos: padding in percent in +Y direction
        :param z_pos: padding in percent in +Z direction
        :param x_neg: padding in percent in -X direction (-R for 2D RZ)
        :param y_neg: padding in percent in -Y direction
        :param z_neg: padding in percent in -Z direction
    ...
    def create_coaxial(self, startingposition, axis, innerradius=1, outerradius=2, dielradius=1.8, length=10,
        ...
        :param axis: CoordinateSystemaxis
        :param innerradius: Inner Coax Radius
        :param outerradius: Outer  Coax Radius
        :param dielradius: Dielectric  Coax Radius
        :param length: Coaxial length
        :param matinner: Material for inner. Default "copper"
        :param matouter: Material for outer. Default "copper"
        :param matdiel: Material for dielectric. Default "teflon_based"
        :return: inner ID, outer ID, diel ID
        """
    ...
    def create_waveguide(self, origin, wg_direction_axis, wgmodel="WG0", wg_length=100, wg_thickness=None,
        ...
        :param wg_direction_axis: axis direction
        :param wgmodel: WG Model.
        :param wg_length: WG length
        :param wg_thickness: WG Thickness. If None it will be wg_height/20
        :param wg_material: WG Material
        :param parametrize_w: Parametrize W
        :param parametrize_h: Parametrize H
        :type parametrize_h: bool
        :return: id of WG
        """
    ...
    def edit_region_dimensions(self, listvalues):
        ...
        :param listvalues: list of region dimension along all 6 directions
        :return: True if succeeded
        """
        arg = ["NAME:AllTabs"]
    ...
    def create_outer_facelist(self, externalobjects, name="outer_faces"):
        ...
        :param externalobjects: list of objects
        :param name: name of facelist
    ...
    def explicitiyly_subract(self, diellist, metallist):
        ...
        :param diellist: list of dielectrics
    ...
    def find_port_faces(self, objs):
        ...
        :param objs: list of input sheets
        :return: list of output sheets (2x len(objs))
        """
        faces = []
        id = 1
        for obj in objs:
    ...
    def vertex_data_of_lines(self, txtfilter=None):
        ...
        Returns:
        line_data: Dictionary of line name: list of vertex positions in 2D/3D
        """
        line_data = {}
    ...
    def get_vertices_of_line(self, sLineName):
        ...
        Returns:
        position_list:  list of positions in [x, y, (z)] form for 2D/3D
        """
        position_list = []
    ...
    def import_3d_cad(self, filename, healing=0, refresh_all_ids=True):
        ...
        :param healing 0,1 define if healing has to be performed
        :param refresh_all_ids: Boolean, refresh all ids after load. It can take a lot of time for big projects
        :return: Boolean
        """
    ...
    def select_all_extfaces(self, mats):
        ...
        :param mats: list of materials to be included into the search. All objects with this materials will be included
    ...
    def select_allfaces_fromobjects(self, elements):
        """
        Select all external faces of a a list of objects
        :param elements: list of elements to be included into the search.
        :output sel: list of faces
        """
        self.messenger.add_info_message("Selecting Outer Faces")
    ...
    def thicken_sheets(self, inputlist, value, internalExtr=True, internalvalue=1):
        ...
        :param inputlist: list of faces to thicken
        :param value: value in mm to thicken
        :param internalExtr: define if the sheet must also be extruded internally
        :param internalvalue: define the value in mm to thicken internally the sheet (vgoing into the model)
        """
        aedt_bounding_box = self.get_model_bounding_box()
        directions = {}
        for el in inputlist:
