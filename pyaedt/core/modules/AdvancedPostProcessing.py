...
class PostProcessor(Post):
    ...
    def get_efields_data(self, setup_sweep_name='', ff_setup="Infinite Sphere1", freq='All'):
        ...
        :param ff_setup: Far Field Setup
        :param freq:
        :return: [theta_range, phi_range, Etheta, Ephi]
        """
    ...
    def _plot_from_aedtplt(self, aedtplt_files=None, imageformat="jpg", view="iso", plot_type="Full",
        ...
        :param aedtplt_files: str or list of aedtplt files generated by AEDT
        :param imageformat: str default output format (jpg, png, svg, webp)
        :param view: str default output view ( iso, x , y, z, all). all option export all the views files
        :param plot_type: "Full"
        :param plot_label: Plot Color Label
        :param model_color: 3D Model Color. Default "silver"
        :param show_model_edge: boolean
    ...
    def plot_field_from_fieldplot(self, plotname, project_path="", meshplot=False, setup_name=None,
        ...
        :param project_path: path where to save the image
        :param meshplot: create and plot the mesh over the fields
        :param setup_name: name of the setup - sweep to use for the export
        :param intrinsic_dict: intrinsic dictionary needed for export of the mesh. Valid only if meshplot is True
        :param imageformat:  image format. Defalult jpg
        :param view: image view. Default iso
        :param plot_label: Plot Type. Default Temperature
        :param plot_folder: Plot Folder to force update before export the field. If none all the plots will be updated
        :return: list of the files exported
        """
        if not plot_folder:
    ...
    def animate_fields_from_aedtplt(self, plotname, plot_folder=None, meshplot=False, setup_name=None,
        ...
        :param plotname: name of the plot to use or name o
        :param plot_folder: optional name of the plot_folder
        :param setup_name: name of the setup - sweep to use for the export
        :param intrinsic_dict: intrinsic dictionary needed for export
        :param variation_variable: variation variable. Default "Phi"
        :param variation_list: list of variation values
        :param project_path: path for the export
        :return: Boolean
        """
        if not plot_folder:
            self.ofieldsreporter.UpdateAllFieldsPlots()
    ...
    def animate_fields_from_aedtplt_2(self, quantityname, object_list, plottype, meshplot=False, setup_name=None,
        ...
        :param quantityname: name of the plot to use or name o
        :param object_list: optional name of the plot_folder
        :param plottype: Plot Type. "Surface", "Volume" or "CutPlane"
        :param setup_name: name of the setup - sweep to use for the export
        :param intrinsic_dict: intrinsic dictionary needed for export
        :param variation_variable: variation variable. Default "Phi"
        :param variation_list: list of variation values
    ...
    def create_3d_plot(self, solution_data, nominal_sweep="Freq", nominal_value=1, primary_sweep="Theta",
        ...
        :param solution_data: Solution Data Input
        :param nominal_sweep: Nominal Sweep Name
        :param nominal_value: Nominal Sweep Value
        :param primary_sweep: Primary Sweep. Default Theta
        :param secondary_sweep: Secondary Sweep. Default Phi
