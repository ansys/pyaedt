...
class AdaptiveSettings(object):
    ...
    @pyaedt_function_handler()
    def add_adaptive_frequency_data(self, low_frequency=0, high_frequency=10e9, max_num_passes=10, max_delta_s=0.02):
...
class HfssSimulationSetup(object):
    ...
    def set_solution_broadband(
        ...
        self.adaptive_settings.adaptive_settings.AdaptiveFrequencyDataList.Clear()
        if not self.adaptive_settings.add_adaptive_frequency_data(
