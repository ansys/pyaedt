...
class EDBPadstack(object):
    ...
    @pyaedt_function_handler()
    def convert_to_3d_microvias(self, convert_only_signal_vias=True, laser_angle=15):
        ...
        rad2 = self.hole_properties[0] / 2 - math.tan(laser_angle * diel_thick * math.pi / 180)
