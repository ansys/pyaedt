...
from pyaedt.edb_grpc.core.edb_data.simulation_configuration import SourceType

# from pyaedt.edb_grpc.core.edb_data.sources import SourceType
from pyaedt.edb_grpc.core.edb_data.sources import CircuitPort
from pyaedt.edb_grpc.core.edb_data.sources import CurrentSource
from pyaedt.edb_grpc.core.edb_data.sources import DCTerminal
from pyaedt.edb_grpc.core.edb_data.sources import PinGroup
from pyaedt.edb_grpc.core.edb_data.sources import ResistorSource
from pyaedt.edb_grpc.core.edb_data.sources import VoltageSource
...
class EdbSiwave(object):
    ...
    def add_siwave_dc_analysis(self, name=None):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.siwave_simulation_setup_data.SiwaveDCSimulationSetup`
            Setup object class.
    ...
    def create_rlc_component(
        ...
        Returns
        -------
        class:`pyaedt.edb_grpc.core.components.Components`
