...
class EdbNets(object):
    ...
    def nets(self):
        ...
        Returns
        -------
        dict[str, :class:`pyaedt.edb_grpc.core.edb_data.nets_data.EDBNetsData`]
            Dictionary of nets.
        """
        nets = {}
    ...
    def signal_nets(self):
        ...
        Returns
        -------
        dict[str, :class:`pyaedt.edb_grpc.core.edb_data.EDBNetsData`]
    ...
    def eligible_power_nets(self, threshold=0.3):
        ...
        Returns
        -------
        list of  :class:`pyaedt.edb_grpc.core.edb_data.EDBNetsData`
        """
        pwr_gnd_nets = []
