...
from pyaedt.edb_grpc.core.edb_data.utilities import EDBStatistics
...
class EdbLayout(object):
    ...
    def _create_path(
        ...
        Parameters
        ----------
        path_list : :class:`pyaedt.edb_grpc.core.layout.Shape`
            List of points.
        layer_name : str
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.primitives_data.EDBPrimitives`
            ``True`` when successful, ``False`` when failed.
        """
    ...
    def create_polygon(self, main_shape, layer_name, voids=[], net_name=""):
        ...
        Returns
        -------
        bool, :class:`pyaedt.edb_grpc.core.edb_data.primitives.EDBPrimitives`
    ...
    def shape_to_polygon_data(self, shape):
        ...
        Parameters
        ----------
        shape : :class:`pyaedt.edb_grpc.core.layout.EdbLayout.Shape`
