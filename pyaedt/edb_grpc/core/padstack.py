...
from pyaedt.edb_grpc.core.edb_data.padstacks_data import EDBPadstack
...
class EdbPadstacks(object):
    ...
    def definitions(self):
        ...
        Returns
        -------
        dict[str, :class:`pyaedt.edb_grpc.core.edb_data.padstacks_data.EdbPadstack`]
    ...
    def padstacks(self):
        ...
        Returns
        -------
        dict[str, :class:`pyaedt.edb_grpc.core.edb_data.EdbPadstack`]
            List of definitions via padstack definitions.
    ...
    def instances(self):
        ...
        Returns
        -------
        dict[str, :class:`pyaedt.edb_grpc.core.edb_data.padstacks_data.EDBPadstackInstance`]
