...
from pyaedt.edb_grpc.core.edb_data.components_data import EDBComponent
from pyaedt.edb_grpc.core.edb_data.components_data import EDBComponentDef
...
class Components(object):
    ...
    def components(self):
        ...
        Returns
        -------
        dict[str, :class:`pyaedt.edb_grpc.core.edb_data.components_data.EDBComponent`]
    ...
    def definitions(self):
        ...
        Returns
        -------
        dict of :class:`pyaedt.edb_grpc.core.edb_data.components_data.EDBComponentDef`"""
