...
class CommonExcitation(object):
    ...
    def net(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.nets_data.EDBNetsData`
        """
...
class ExcitationPorts(CommonExcitation):
    ...
    def reference_object(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.padstacks_data.EDBPadstackInstance` or
    ...
    def get_padstack_terminal_reference_pin(self, gnd_net_name_preference=None):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.padstack_data.EDBPadstackInstance`
        """
    ...
    def get_pad_edge_terminal_reference_pin(self, gnd_net_name_preference=None):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.padstacks_data.EDBPadstackInstance`
        """
