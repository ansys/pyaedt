...
from pyaedt.edb_grpc.core.edb_data.sources import Source
...
class SimulationConfigurationBatch(object):
    ...
    def sources(self):  # pragma: no cover
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.sources.Source`
        """
    ...
    def add_source(self, source=None):  # pragma: no cover
        ...
        Parameters
        ----------
        source :  :class:`pyaedt.edb_grpc.core.edb_data.sources.Source`
...
class SimulationConfiguration(object):
    ...
    def dc_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core_edb_data.simulationconfiguration.SimulationConfigurationDc`
        """
    ...
    def ac_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core_edb_data.simulationconfiguration.SimulationConfigurationAc`
        """
    ...
    def batch_solve_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core_edb_data.simulationconfiguration.SimulationConfigurationBatch`
        """
