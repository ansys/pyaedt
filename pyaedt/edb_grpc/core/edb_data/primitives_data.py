...
class EDBPrimitives(object):
    ...
    def add_void(self, point_list):
        ...
        Parameters
        ----------
        point_list : list or  :class:`pyaedt.edb_grpc.core.edb_data.primitives_data.EDBPrimitives`
        or EDB Primitive Object
    ...
    def subtract(self, primitives):
        ...
        Parameters
        ----------
        primitives : :class:`pyaedt.edb_grpc.core.edb_data.EDBPrimitives` or EDB PolygonData or EDB Primitive or list

        Returns
        -------
        List of :class:`pyaedt.edb_grpc.core.edb_data.EDBPrimitives`
        """
    ...
    def intersection_type(self, primitive):
        ...
        Parameters
        ----------
        primitive : :class:`pyaeedt.edb_grpc.core.edb_data.primitives_data.EDBPrimitives` or `PolygonData`
