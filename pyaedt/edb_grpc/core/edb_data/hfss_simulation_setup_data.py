...
class AdaptiveSettings(object):
    ...
    def adaptive_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.AdaptiveSettings`
        """
    ...
    def adaptive_frequency_data_list(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.AdaptiveFrequencyData`
        """
...
class HfssSimulationSetup(object):
    ...
    def frequency_sweeps(self):
        ...
        Returns
        -------
        List of :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.EdbFrequencySweep`
        """
        sweep_data_list = {}
    ...
    def hfss_solver_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.HfssSolverSettings`
    ...
    def defeature_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.DefeatureSettings`
    ...
    def via_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.ViaSettings`
    ...
    def advanced_mesh_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.AdvancedMeshSettings`
    ...
    def curve_approx_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.CurveApproxSettings`
    ...
    def dcr_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.DcrSettings`
    ...
    def hfss_port_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.HfssPortSettings`
    ...
    def mesh_operations(self):
        ...
        Returns
        -------
        List of :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.MeshOperation`
    ...
    def add_length_mesh_operation(
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.LengthMeshOperation`
        """
        if not name:
    ...
    def add_frequency_sweep(self, name=None, frequency_sweep=None):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data.EdbFrequencySweep`
