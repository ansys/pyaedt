from pyaedt.edb_grpc.core.edb_data.hfss_simulation_setup_data import EdbFrequencySweep
from pyaedt.edb_grpc.core.general import convert_netdict_to_pydict
from pyaedt.edb_grpc.core.general import convert_pydict_to_netdict
...
class SiwaveSYZSimulationSetup(SiwaveAdvancedSettings, object):
    ...
    def dc_settings(self):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.siwave_simulation_setup_data.SiwaveDCAdvancedSettings`
        """
    ...
    def add_frequency_sweep(self, name=None, frequency_sweep=None):
        ...
        Returns
        -------
        :class:`pyaedt.edb_grpc.core.edb_data.simulation_setup_data.EdbFrequencySweep`
