...
from pyaedt.edb_grpc.core.edb_data.sources import ExcitationBundle
...
from pyaedt.edb_grpc.core.general import convert_pytuple_to_nettuple
...
class EdbHfss(object):
    ...
    def create_differential_wave_port(
        ...
        -------
        tuple
            The tuple contains: (port_name, pyaedt.edb_grpc.core.edb_data.sources.ExcitationDifferential).
    ...
    def create_wave_port(
        ...
        -------
        tuple
            The tuple contains: (Port name, pyaedt.edb_grpc.core.edb_data.sources.Excitation).
