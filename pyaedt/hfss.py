...
class Hfss(FieldAnalysis3D, object):
    ...
    @aedt_exception_handler
    def create_sbr_file_based_antenna(self, ffd_full_path, antenna_size="1mm", antenna_impedance="50ohm", representation_type="Far Field", target_cs=None, model_units=None, parameters_dict=None, antenna_name=None):
        """Create a linked antenna.
        ...
        self._create_sbr_parametric_antenna("File Based Antenna", target_cs, model_units, par_dicts,
