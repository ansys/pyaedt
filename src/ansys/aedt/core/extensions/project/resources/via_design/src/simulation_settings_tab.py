...
def create_simulation_settings_ui(tab_frame, app_instance):
    ...
    ttk.Radiobutton(freq_options_frame, text='Single', variable=freq_type, 
                   value='single').pack(side='left')
    ttk.Radiobutton(freq_options_frame, text='Multi-Frequencies', variable=freq_type, 
                   value='multi').pack(side='left', padx=20)
    ttk.Radiobutton(freq_options_frame, text='Broadband', variable=freq_type, 
                   value='broadband').pack(side='left')
    ...
    ttk.Radiobutton(adaptive_frame, text='Maximum Delta S', variable=conv_type, 
                   value='delta_s').pack(anchor='w', padx=25)
    ...
    ttk.Radiobutton(adaptive_frame, text='Use Matrix Convergence', variable=conv_type, 
                   value='matrix').pack(anchor='w', padx=25)
    ...
    ttk.Checkbutton(fields_frame, text='Save radiated fields only', 
                   variable=save_rad).pack(anchor='w', padx=25)
    ...
    ttk.Checkbutton(lambda_frame, text='Do Lambda Refinement', 
                   variable=lambda_var).pack(side='left')
    ...
    ttk.Checkbutton(lambda_frame, text='Use Default Value', 
                   variable=default_var).pack(side='left', padx=5)
    ...
    ttk.Checkbutton(max_refine_limit_frame, text='Maximum Refinement:', 
                   variable=max_limit_var).pack(side='left')
    ...
    ttk.Radiobutton(solution_frame, text='Auto Select Direct/Iterative', 
                   variable=solver_var, value='auto').pack(anchor='w', padx=5)
    ttk.Radiobutton(solution_frame, text='Direct Solver', 
                   variable=solver_var, value='direct').pack(anchor='w', padx=5)
    ttk.Radiobutton(solution_frame, text='Iterative Solver', 
                   variable=solver_var, value='iterative').pack(anchor='w', padx=5)
