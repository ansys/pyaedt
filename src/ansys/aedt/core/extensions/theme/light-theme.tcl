...
namespace eval ttk::theme::light-theme {

    variable version 1.0
    package provide ttk::theme::light-theme $version
    variable colors
    array set colors {
        -fg             "#313131"
        -bg             "#ffffff"
    ...
    LoadImages [file join [file dirname [info script]] light-theme]

    # Settings
    ttk::style theme create light-theme -parent default -settings {
        ttk::style configure . \
