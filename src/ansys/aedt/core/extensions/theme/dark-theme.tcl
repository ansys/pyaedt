...
namespace eval ttk::theme::dark-theme {

    variable version 1.0
    package provide ttk::theme::dark-theme $version
    variable colors
    array set colors {
        -fg             "#eeeeee"
        -bg             "#313131"
    ...
    LoadImages [file join [file dirname [info script]] dark-theme]

    # Settings
    ttk::style theme create dark-theme -parent default -settings {
        ttk::style configure . \
