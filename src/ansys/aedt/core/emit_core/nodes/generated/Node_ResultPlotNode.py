class Node_ResultPlotNode(GenericEmitNode):
    ...
    @property
    def get_show_emi_thresholds(self):
        """Show EMI Thresholds
        "Toggles on/off visibility of the EMI Thresholds."
        "Value should be 'true' or 'false'."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Show EMI Thresholds')
    def set_show_emi_thresholds(self, value):
