class Node_RxSelectivityNode(GenericEmitNode):
    ...
    @property
    def get_use_arithmetic_mean(self):
        """Use Arithmetic Mean
        "Uses arithmetic mean to center bandwidths about the tuned channel frequency."
        "Value should be 'true' or 'false'."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Use Arithmetic Mean')
    def set_use_arithmetic_mean(self, value):
