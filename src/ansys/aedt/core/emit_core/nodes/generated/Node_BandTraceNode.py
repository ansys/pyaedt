class Node_BandTraceNode(GenericEmitNode):
    ...
    @property
    def get_tx_or_rx(self):
        """Tx or Rx
        "Specifies whether the trace is a Tx or Rx channel."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Tx or Rx')
    def set_tx_or_rx(self, value):
