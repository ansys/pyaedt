class Node_TxHarmonicNode(GenericEmitNode):
    ...
    @property
    def get_harmonic_table_units(self):
        """Harmonic Table Units
        "Specifies the units for the Harmonics."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Harmonic Table Units')
    def set_harmonic_table_units(self, value):
