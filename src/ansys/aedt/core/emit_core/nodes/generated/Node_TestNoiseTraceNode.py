class Node_TestNoiseTraceNode(GenericEmitNode):
    ...
    def get_frequency_1(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Frequency 1')
    def set_frequency_1(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Frequency 1=' + value])

    @property
    def get_amplitude_1(self):
        """Amplitude 1
        "1st test tone amplitude."
        "Value should be between -100 and 200."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Amplitude 1')
    def set_amplitude_1(self, value):
    ...
    def get_bandwidth_1(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Bandwidth 1')
    def set_bandwidth_1(self, value):
    ...
    def get_frequency_2(self):
        ...
        "Value should be between 1 and 100e9."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Frequency 2')
    def set_frequency_2(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Frequency 2=' + value])

    @property
    def get_amplitude_2(self):
        """Amplitude 2
        "2nd test tone amplitude."
        "Value should be between -100 and 200."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Amplitude 2')
    def set_amplitude_2(self, value):
    ...
    def get_bandwidth_2(self):
        ...
        "Value should be between 1 and unbounded."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Bandwidth 2')
    def set_bandwidth_2(self, value):
    ...
    def get_noise_level(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Noise Level')
