class Node_SparameterTraceNode(GenericEmitNode):
    ...
    def get_input_port(self):
        """Input Port
        "Specifies input port for the plotted S-Parameter component."
        """
    ...
    class InputPortOption(Enum):
        (
            ::DATASOURCE::PORTNAMES = "::DataSource::PortNames"
        )

    @property
    def get_output_port(self):
        """Output Port
        "Specifies output port for the plotted S-Parameter component."
        """
