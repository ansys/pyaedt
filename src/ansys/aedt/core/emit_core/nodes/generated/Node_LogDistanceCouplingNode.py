class Node_LogDistanceCouplingNode(GenericEmitNode):
    ...
    def get_path_loss_exponent(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Path Loss Exponent')
    def set_path_loss_exponent(self, value):
