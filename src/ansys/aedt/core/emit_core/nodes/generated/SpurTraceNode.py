...
class SpurTraceNode(GenericEmitNode):
    ...
    def channel_frequency(self):
        ...
        "        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Channel Frequency')
        key_val_pair = [i for i in props if 'Channel Frequency=' in i]
    ...
    def channel_frequency(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Channel Frequency=' + value])
