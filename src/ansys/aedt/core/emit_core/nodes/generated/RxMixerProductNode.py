...
class RxMixerProductNode(EmitNode):
    ...
    def _80_db_bandwidth(self, value : float|str):
        value = self._convert_to_internal_units(value, "Freq")
        self._oRevisionData.SetEmitNodeProperties(self._result_id,self._node_id,[f'80 dB Bandwidth={value}'])
    ...
    def _1st_if_frequency(self, value):
        self._oRevisionData.SetEmitNodeProperties(self._result_id,self._node_id,[f'1st IF Frequency={value}'])
