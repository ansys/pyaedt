...
class TxSpectralProfNode(EmitNode):
    ...
    def _2nd_harmonic_level(self, value) -> float:
        self._oRevisionData.SetEmitNodeProperties(self._result_id,self._node_id,[f'2nd Harmonic Level={value}'])
    ...
    def _3rd_harmonic_level(self, value) -> float:
        self._oRevisionData.SetEmitNodeProperties(self._result_id,self._node_id,[f'3rd Harmonic Level={value}'])
