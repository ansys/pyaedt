class Node_IndoorPropagationCouplingNode(GenericEmitNode):
    ...
    def get_building_type(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Building Type')
    def set_building_type(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Building Type=' + value])
    ...
    def get_number_of_floors(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Number of Floors')
    def set_number_of_floors(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Number of Floors=' + value])
