class Node_SpurTraceNode(GenericEmitNode):
    ...
    def get_channel_frequency(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Channel Frequency')
    def set_channel_frequency(self, value):
