...
class TwoRayPathLossCouplingNode(EmitNode):
    ...
    def ground_reflection_coeff(self, value: float):
        self._oDesign.GetModule('EmitCom').SetEmitNodeProperties(self._result_id,self._node_id,['Ground Reflection Coeff.=' + value])
    ...
    def pointspeak(self, value: int):
        self._oDesign.GetModule('EmitCom').SetEmitNodeProperties(self._result_id,self._node_id,['Points/Peak=' + value])
