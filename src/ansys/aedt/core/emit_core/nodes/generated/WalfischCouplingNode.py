...
class WalfischCouplingNode(GenericEmitNode):
    ...
    @property
    def path_loss_type(self):
        """Path Loss Type
        "Specify LOS vs NLOS for the Walfisch-Ikegami model."
        "        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Path Loss Type')
        key_val_pair = [i for i in props if 'Path Loss Type=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @path_loss_type.setter
    def path_loss_type(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Path Loss Type=' + value])
    ...
    def roof_height(self) -> float:
        ...
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Roof Height')
        key_val_pair = [i for i in props if 'Roof Height=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @roof_height.setter
    def roof_height(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Roof Height=' + value])
    ...
    def distance_between_buildings(self) -> float:
        ...
        "Value should be between 0 and 100."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Distance Between Buildings')
        key_val_pair = [i for i in props if 'Distance Between Buildings=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @distance_between_buildings.setter
    def distance_between_buildings(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Distance Between Buildings=' + value])
    ...
    def street_width(self) -> float:
        ...
        "Value should be between 0 and 100."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Street Width')
        key_val_pair = [i for i in props if 'Street Width=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @street_width.setter
    def street_width(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Street Width=' + value])
    ...
    def incidence_angle(self) -> float:
        ...
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Incidence Angle')
        key_val_pair = [i for i in props if 'Incidence Angle=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @incidence_angle.setter
    def incidence_angle(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Incidence Angle=' + value])
