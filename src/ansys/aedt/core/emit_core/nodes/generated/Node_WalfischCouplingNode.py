class Node_WalfischCouplingNode(GenericEmitNode):
    ...
    @property
    def get_path_loss_type(self):
        """Path Loss Type
        "Specify LOS vs NLOS for the Walfisch-Ikegami model."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Path Loss Type')
    def set_path_loss_type(self, value):
    ...
    def get_roof_height(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Roof Height')
    def set_roof_height(self, value):
    ...
    def get_distance_between_buildings(self):
        ...
        "Value should be between 0 and 100."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Distance Between Buildings')
    def set_distance_between_buildings(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Distance Between Buildings=' + value])

    @property
    def get_street_width(self):
        """Street Width
        "Width of the street.."
        "Value should be between 0 and 100."
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Street Width')
    def set_street_width(self, value):
    ...
    def get_incidence_angle(self):
        ...
        """
        return oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Incidence Angle')
