...
class TestNoiseTraceNode(GenericEmitNode):
    ...
    def input_port(self) -> int:
        ...
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Input Port')
        key_val_pair = [i for i in props if 'Input Port=' in i]
    ...
    def output_port(self) -> int:
        ...
        "Value should be greater than 1."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Output Port')
        key_val_pair = [i for i in props if 'Output Port=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    ...
    def frequency_1(self) -> float:
        ...
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Frequency 1')
        key_val_pair = [i for i in props if 'Frequency 1=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    ...
    def frequency_1(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Frequency 1=' + value])
    ...
    def amplitude_1(self) -> float:
        ...
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Amplitude 1')
        key_val_pair = [i for i in props if 'Amplitude 1=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    ...
    def amplitude_1(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Amplitude 1=' + value])
    ...
    def bandwidth_1(self) -> float:
        ...
        "Value should be greater than 1."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Bandwidth 1')
        key_val_pair = [i for i in props if 'Bandwidth 1=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @bandwidth_1.setter
    def bandwidth_1(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Bandwidth 1=' + value])
    ...
    def frequency_2(self) -> float:
        ...
        "Value should be between 1 and 1e+11."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Frequency 2')
        key_val_pair = [i for i in props if 'Frequency 2=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    ...
    def frequency_2(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Frequency 2=' + value])
    ...
    def amplitude_2(self) -> float:
        ...
        "Value should be between -100 and 200."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Amplitude 2')
        key_val_pair = [i for i in props if 'Amplitude 2=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    ...
    def amplitude_2(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Amplitude 2=' + value])
    ...
    def bandwidth_2(self) -> float:
        ...
        "Value should be greater than 1."
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Bandwidth 2')
        key_val_pair = [i for i in props if 'Bandwidth 2=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    @bandwidth_2.setter
    def bandwidth_2(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Bandwidth 2=' + value])
    ...
    def noise_level(self) -> float:
        ...
        """
        props = oDesign.GetModule('EmitCom').GetProperties(self._result_id,self._node_id,'Noise Level')
        key_val_pair = [i for i in props if 'Noise Level=' in i]
        if len(key_val_pair) != 1:
            return ''
        val = key_val_pair[1].split('=')[1]
        return val
    ...
    def noise_level(self, value):
        oDesign.GetModule('EmitCom').SetProperties(self._result_id,self._node_id,['Noise Level=' + value])
