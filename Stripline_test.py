...
# -------------------------------------------------------------
yarn_names_bot = hfss.modeler.create_weave(sub_bot, weave_style="7628", name_prefix="BotWeave")
yarn_names_top = hfss.modeler.create_weave(sub_top, weave_style="7628", name_prefix="TopWeave")

# yarn_names_bot = hfss.modeler.create_weave_homogenized(sub_bot, weave_style="7628", name_prefix="BotWeave")
# yarn_names_top = hfss.modeler.create_weave_homogenized(sub_top, weave_style="7628", name_prefix="TopWeave")
