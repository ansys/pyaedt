...
aedtapp.mesh.assign_model_resolution(entities=[o1.name, o3.name], defeature_length=None)
aedtapp.mesh.assign_length_mesh(entities=o2.faces, inside_selection=False, maximum_length=1, maximum_elements=2000)
