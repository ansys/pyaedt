...
def create_scenario_view(emis, colors, tx_radios, rx_radios):
    ...
    fig.update_layout(
        title=dict(text="Interference Type Classification", font=dict(color="darkslategray", size=20), x=0.5), width=600
    )
    fig.show()
...
def create_legend_table():
    ...
    classifications = ["In-band/In-band", "Out-of-band/In-band", "In-band/Out-of-band", "Out-of-band/Out-of-band"]
    fig = go.Figure(
        data=[
            go.Table(
                header=dict(
                ...
                cells=dict(
                    ...
                    line_color="darkslategray",
                    fill_color=[
                        [table_colors["red"], table_colors["orange"], table_colors["yellow"], table_colors["green"]]
                    ],
                    align=["center"],
                    height=25,
                    font=dict(color=["darkslategray", "black"], size=15),
