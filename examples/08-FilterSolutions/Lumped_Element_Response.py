...
design.export_to_aedt.overwrite_design_to_aedt()
design.export_to_aedt.overwrite_design_to_pythonaedt("gg")


design.attributes.filter_class = FilterClass.BAND_PASS
design.attributes.filter_type = FilterType.CHEBYSHEV_I
