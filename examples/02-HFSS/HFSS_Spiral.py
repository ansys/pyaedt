...
hfss.lumped_port(signal="port1", integration_line_location=pyaedt.constants.AXIS.Z)
...
hfss.lumped_port(signal="port2", integration_line_location=pyaedt.constants.AXIS.Z)
