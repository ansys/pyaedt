...
ffdata.plot_farfield_contour(
    qty_str="RealizedGain", convert_to_db=True, title="Contour at {}Hz".format(ffdata.frequency)
)
...
ffdata.plot_2d_cut(
    primary_sweep="phi", secondary_sweep_value=30, qty_str="RealizedGain", title="Elevation", convert_to_db=True
)
...
ffdata.polar_plot_3d(qty_str="RealizedGain", convert_to_db=True)
