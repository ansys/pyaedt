...
M3D = Maxwell3d(projectname=Project_Name,designname=Design_Name,solution_type=Solver,specified_version=DesktopVersion, non_graphical=NonGraphical)
...
M3D.modeler.primitives.create_cylinder(cs_axis='Z', position=[0,'Coil_Position',15], radius=40, height=20,name="SearchCoil", matname="copper")
M3D.modeler.primitives.create_cylinder(cs_axis='Z', position=[0,'Coil_Position',15], radius=20, height=20,name="Bore", matname="copper")
...
Opt.EditSetup ("CoilSweep",["NAME:CoilSweep","IsEnabled:=",True,
    ["NAME:ProdOptiSetupDataV2","SaveFields:=",True,"CopyMesh:=",False,"SolveWithCopiedMeshOnly:=",True],
    ["NAME:StartingPoint"],"Sim. Setups:=",["Setup1"],["NAME:Sweeps",
        ["NAME:SweepDefinition","Variable:=","Coil_Position","Data:=","LIN -20mm 0mm 20mm","OffsetF1:=",False,
            "Synchronize:=",0]],["NAME:Sweep Operations"],["NAME:Goals"]])
...
Plot.CreateReport("mag(Bz) Along 'Line_AB' Offset Coil","Fields","Rectangular Plot","Setup1 : LastAdaptive",
...
Plot.CreateReport("mag(Bz) Along 'Line_AB' Centred Coil","Fields","Rectangular Plot","Setup1 : LastAdaptive",
                     ["Context:=","Line_AB","PointCount:=",1001],
