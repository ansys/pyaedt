...
# HFSS will have two design variables, ``w1`` and ``w2``.
...
###############################################################################
# Create a setup and a frequency sweep to use as the base for the Optimetrics setups.
...
# ------------------------------------
# DX based on a goal and calculation.
...
# ---------------------------------------------
# DOE based on a goal and calculation.
